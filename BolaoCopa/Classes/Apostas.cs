...
namespace BolaoCopa.Classes
{
    public class Apostas
    {
        ...
        // método de get da propriedade Apostador
        public Int32 getApostador()
        {
            return Apostador;
        }

        // método de set da propriedade Apostador
        public void setApostador(Int32 apostador)
        {
            Apostador = apostador;
        }
        ...
        private String InstrucaoSQL()
        {
            ...
            if (!Cadastrado())
            {
                ...
                sql = "INSERT INTO apostas VALUES (" + Apostador.ToString() + ", " + Jogo.ToString() + ", " + Gols_A.ToString() + ", " + Gols_B.ToString() + ", 0)";
            }
            // o resultado da partida já está gravado. Deve-se portanto, atualizá-lo
            else
            {
                // define a instrução sql de inclusão dos dados
                sql = "UPDATE apostas SET gols_a = " + Gols_A.ToString() + ", gols_b = " + Gols_B.ToString() + " WHERE apostador = " + Apostador.ToString() + " AND jogo = " + Jogo.ToString();
            }
